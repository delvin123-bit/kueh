...
if(isset($_POST['submit'])){
 ...
 //var_dump($value);
//array(2) { [21]=> string(1) "5" [22]=> string(1) "6" } 
//insert into orders(userId,productId,quantity) values('4','21','5')
//insert into orders(userId,productId,quantity) values('4','22','6')

		foreach($value as $qty=> $val34){
		  $SQL="insert into orders(userId,productId,quantity) values('".$_SESSION['id']."','$qty','$val34')";
		  //echo $SQL;
...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Rp"." ".$row['productPrice']; ?>k</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Rp"." ".$row['shippingCharge']; ?>k</span></td>

					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo ($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?>k</span></td>
				</tr>
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Alamat Pelanggan</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Alamat Rumah<span>*</span></label>
			 ...
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Negara<span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Pin Code<span>*</span></label>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Alamat Penagihan(HARAP ISI SAMA DENGAN ALAMAT PELANGGAN)</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
					    <label class="info-title" for="Shipping Address">Alamat Rumah<span>*</span></label>
...
<div class="col-md-4 col-sm-12 cart-shopping-total">
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Total Semua<span class="inner-left-md"><?php echo $_SESSION['Rp']="$totalprice". "k"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
	...
	<?php } else {
echo "Pembelanjaan Kamu Kosong Saat Ini";
		}?>
</div>			</div>
		</div> 
		</form>
