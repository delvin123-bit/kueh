...
?>
						...
						<div class="price">Rs. 
							...
							<span><?php echo htmlentities($row['ppriceb']);?>.00</span>
						</div>
					</td>
					<td class="col-md-2">
