					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active " id="grid-container">
							<div class="category-product  inner-top-vs">
								<div class="row">									
			<?php
$ret=mysqli_query($con,"select * from products where category='$cid' and `productStock`>0");
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					...
					<br><span class="price">Stock 
					<?php echo htmlentities($row['productStock']);?> Item</span>
			</div><!-- /.product-price -->
