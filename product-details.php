...
<div class="sidebar-widget hot-deals wow fadeInUp">
	<h3 class="section-title">product unggulan</h3>
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									Rp.<?php echo htmlentities($rws['productPrice']);?>.000
								</span>
									
							    <span class="price-before-discount">Rp. <?php echo htmlentities($row['productPriceBeforeDiscount']);?>.000</span>					
...
<div class="col-sm-9">
<div class="stock-box">
<span class="value">Rp.<?php if($row['shippingCharge']==0)
{
echo "Free";
}
else
...
<div class="col-sm-9">
<div class="stock-box">
<span class="value"><?php if($row['productStock']<1)
{
echo "Not Available";
}
else
{
echo htmlentities($row['productStock']);
}
...
?></span>
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">Rp.<?php echo htmlentities($row['productPrice']);?>.000</span>
											<span class="price-strike">Rp.<?php echo htmlentities($row['productPriceBeforeDiscount']);?>.000</span>
										</div>
									</div>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					Rp.<?php echo htmlentities($rw['productPrice']);?>.000</span>
				<span class="price-before-discount">Rp.
					<?php echo htmlentities($rw['productPriceBeforeDiscount']);?>.000</span>
