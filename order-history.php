...
function PRINT(pk){ 
win=window.open('nota.php?id='+pk,'win','width=1000, height=400, menubar=0, scrollbars=1, resizable=0, location=0, toolbar=0, status=0'); } 
...
<?php 
$sql_p="SELECT distinct(orderDate) FROM orders WHERE orders.userId='".$_SESSION['id']."' order by orders.`id` desc";
$query_p=mysqli_query($con,$sql_p);
if(mysqli_num_rows($query_p)!=0){
while($GR=mysqli_fetch_array($query_p)){
$kelompok=$GR['orderDate'];	

echo"<tr bgcolor='#dddddd'><td colspan='12'>
	<b><big>Nota $kelompok | <a href='#'  OnClick='PRINT(\"$kelompok\")'>
	<img src='print.png' title='cetak nota'></a></big></b></tr>";
