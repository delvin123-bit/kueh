...
$sql=mysqli_query($con,"update  products set category='$category',subCategory='$subcat',productStock='$productStock',productName='$productname',productCompany='$productcompany',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
...
<div class="controls">
<input type="text"    name="productStock" value="<?php echo htmlentities($row['productStock']);?>"  placeholder="Enter Product Stock" class="span4 tip" required>
</div>
</div>
