...
<font color='red'><b>Today's Orders</b></font>
<?php
$f1="00:00:00";
$from=date('Y-m-d')." ".$f1;
$t1="23:59:59";
...
<i class="icon-tasks"></i>
<font color='red'><b>Pending Orders</b></font>
<?php	
$status='Delivered';									 
...
<font color='red'><b>Delivered Orders</b></font>
<?php	
$status='Delivered';									 
...
<li>
<a href="pending-orderss.php">
<i class="icon-tasks"></i>
<font color='red'><b>Pending Reports</b></font>
<?php	
$status='Delivered';									 
$ret = mysqli_query($con,"SELECT * FROM Orders where orderStatus!='$status' || orderStatus is null ");
$num = mysqli_num_rows($ret);
...
<li>
<a href="delivered-orderss.php">
<i class="icon-inbox"></i>
<font color='red'><b>Delivered Reports</b></font>
<?php	
$status='Delivered';									 
$rt = mysqli_query($con,"SELECT * FROM Orders where orderStatus='$status'");
$num1 = mysqli_num_rows($rt);
