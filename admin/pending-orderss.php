...
<head>
	...
	<title>Admin| Pending Report</title>
...
function PRINT(){ 
win=window.open('../report.php?st=Pending','win','width=1000, height=400, menubar=0, scrollbars=1, resizable=0, location=0, toolbar=0, status=0'); } 
