...
$sql=mysqli_query($con,"insert into products(category,productStock,subCategory,productName,productCompany,productPrice,productDescription,shippingCharge,productAvailability,productImage1,productImage2,productImage3,productPriceBeforeDiscount) values('$category','$productStock','$subcat','$productname','$productcompany','$productprice','$productdescription','$productscharge','$productavailability','$productimage1','$productimage2','$productimage3','$productpricebd')");
...
<div class="controls">
<input type="text"    name="productStock"  placeholder="Enter Product Stock" class="span4 tip" required>
</div>
</div>
